...
const ALLOWED_SHEETS = new Set(['Categories', 'Equipments', 'Users', 'Settings', 'Transactions', 'ALL', 'Personnel', 'Departments']);
const ADMIN_ONLY_WRITE_SHEETS = new Set(['Users', 'Settings', 'Personnel', 'Departments']);
